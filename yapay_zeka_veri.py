...
# =====================================================================
# 🛠️ AMELİYAT BÖLGESİ: TRADINGVIEW %100 UYUM ENTEGRASYONU
# =====================================================================
# Eski ticker.history() yerine cuma kapanış mumu fırlatan yf.download entegre edildi hoca!
df = yf.download(secilen_sembol, period=ayar['period'], interval="1d")
...
# 🚨 YENİ EKLENECEK SATIR: MultiIndex karmaşasını ve hata fırlatan o başlıkları temizler!
#  BAŞLIK KAYMASINI KÖKTEN ÇÖZEN KUSURSUZ DÜZLEŞTİRME
df.columns = df.columns.get_level_values(0)
df = df.loc[:, ~df.columns.duplicated()] # Hayalet Price sütununu tamamen uçurur hoca!
